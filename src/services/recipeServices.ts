...
class RecipeServices {
  ...
  async addRecipe(data: iRecipeInfo) {

    const { title, description, ingredients, categoriaID, authorID }: iRecipeInfo = data;
...
export default RecipeServices;import prisma from "@/libs/prisma";
import { iRecipeInfo } from "@/interfaces/recipeInterfaces";
